...
namespace TrafficComet.WebApiTest.Controllers
{
    ...
    public class ValuesController : Controller
    {
        ...
        public async Task<IActionResult> TestHttpClientAsync([FromServices]SplunkHttpClient mockSplunkHttpClient)
        {
            if (mockSplunkHttpClient == null)
                throw new ArgumentNullException(nameof(mockSplunkHttpClient));

            var response = await mockSplunkHttpClient.HttpClient
                .GetStringAsync("http://localhost:53133/api/values");
